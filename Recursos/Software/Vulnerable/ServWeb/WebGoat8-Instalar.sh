...
# ----------
# Script de NiPeGun para instalar y configurar WebGoat8 en Debian
#
# Ejecución remota (puede requerir permisos sudo):
#   curl -sL https://raw.githubusercontent.com/nipegun/dh-scripts/refs/heads/main/Recursos/Software/Vulnerable/ServWeb/WebGoat8-Instalar.sh | bash
#
# Ejecución remota como root (para sistemas sin sudo):
#   curl -sL https://raw.githubusercontent.com/nipegun/dh-scripts/refs/heads/main/Recursos/Software/Vulnerable/ServWeb/WebGoat8-Instalar.sh | sed 's-sudo--g' | bash
#
# Bajar y editar directamente el archivo en nano
#   curl -sL https://raw.githubusercontent.com/nipegun/dh-scripts/refs/heads/main/Recursos/Software/Vulnerable/ServWeb/WebGoat8-Instalar.sh | nano -
# ----------
...
#
# Ejecución remota (puede requerir permisos sudo):
#   curl -sL https://raw.githubusercontent.com/nipegun/dh-scripts/refs/heads/main/SoftInst/Vulnerable/ServWeb/WebGoat8-Instalar.sh | bash
#
# Ejecución remota como root (para sistemas sin sudo):
#   curl -sL https://raw.githubusercontent.com/nipegun/dh-scripts/refs/heads/main/SoftInst/Vulnerable/ServWeb/WebGoat8-Instalar.sh | sed 's-sudo--g' | bash
#
# Bajar y editar directamente el archivo en nano
#   curl -sL https://raw.githubusercontent.com/nipegun/dh-scripts/refs/heads/main/SoftInst/Vulnerable/ServWeb/WebGoat8-Instalar.sh | nano -
# ----------
...
# Ejecutar comandos dependiendo de la versión de Debian detectada
  ...
  if [ $cVerSO == "13" ]; then
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de WebGoat8 para Debian 13 (x)...${cFinColor}"
    echo ""
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de WebGoat8 para Debian 12 (Bookworm)...${cFinColor}"
    echo ""
    ...
    # Crear el menú
      ...
      menu=(dialog --checklist "Marca las opciones que quieras instalar:" 22 80 16)
        opciones=(
          ...
          2 "Instalar la versión 8 a nivel de usuario para ejecutar manualmente"   off
          3 "Instalar la versión 8 a nivel de sistema como un servicio de systemd" off
        )
          ...
          case $choice in
            ...
            2)
              ...
              # Descargar el archivo.jar
                ...
                curl -L https://github.com/WebGoat/WebGoat/releases/download/$vEtiquetaUltVers/webgoat-server-$vNumUltVers.jar -o ~/bin/java/webgoat-$vNumUltVers.jar
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de WebGoat8 para Debian 11 (Bullseye)...${cFinColor}"
    echo ""
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de WebGoat8 para Debian 10 (Buster)...${cFinColor}"
    echo ""
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de WebGoat8 para Debian 9 (Stretch)...${cFinColor}"
    echo ""
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de WebGoat8 para Debian 8 (Jessie)...${cFinColor}"
    echo ""
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de WebGoat8 para Debian 7 (Wheezy)...${cFinColor}"
    echo ""
