...
# ----------
# Script de NiPeGun para instalar en Debian las diferentes Wordlists con hashes MD5 pre-calculados
#
# Ejecución remota (puede requerir permisos sudo):
#   curl -sL https://raw.githubusercontent.com/nipegun/dh-scripts/refs/heads/main/Recursos/WordLists/EnHashes-Instalar-MD5.sh | bash
#
# Ejecución remota como root (para sistemas sin sudo):
#   curl -sL https://raw.githubusercontent.com/nipegun/dh-scripts/refs/heads/main/Recursos/WordLists/EnHashes-Instalar-MD5.sh | sed 's-sudo--g' | bash
#
# Ejecución remota como root indicando diferentes carpetas (para sistemas sin sudo):
#   curl -sL https://raw.githubusercontent.com/nipegun/dh-scripts/refs/heads/main/Recursos/WordLists/EnHashes-Instalar-MD5.sh | sed 's-sudo--g' | bash -s "/WordLists/tmp" "/WordLists"
#
# Bajar y editar directamente el archivo en nano
#   curl -sL https://raw.githubusercontent.com/nipegun/dh-scripts/refs/heads/main/Recursos/WordLists/EnHashes-Instalar-MD5.sh | nano -
# ----------
                ...
                if fCalcularEspacioLibre 0.3; then
                  ...
                  # Descomprimir archivo hacia la ubicación final
                    ...
                    # Renombar el archivo de wordlist a su nombre final
                      mv -vf "$vCarpetaDeWordLists"/EnHashes/MD5/WeakPass-RockYou/rockyou.txt.md5.txt "$vCarpetaDeWordLists"/EnHashes/MD5/MD5-WeakPass-RockYou.txt
              ...
              # Calcular espacio libre disponible antes de instalar la WordList
                if fCalcularEspacioLibre 89; then
                  ...
                  # Descomprimir archivo hacia la ubicación final
                    ...
                    # Renombar el archivo de wordlist a su nombre final
                      mv -vf "$vCarpetaDeWordLists"/EnHashes/MD5/WeakPass-4Latin/weakpass_4.latin.txt.md5.txt "$vCarpetaDeWordLists"/EnHashes/MD5/MD5-WeakPass-4Latin.txt
                    # Borrar el archivo comprimido recién descomprimido
              ...
              # Calcular espacio libre disponible antes de instalar la WordList
                if fCalcularEspacioLibre 148; then
                  ...
                  # Descomprimir archivo hacia la ubicación final
                    ...
                    # Renombar el archivo de wordlist a su nombre final
                      mv -vf "$vCarpetaDeWordLists"/EnHashes/MD5/WeakPass-4Merged/weakpass_4.merged.txt.md5.txt "$vCarpetaDeWordLists"/EnHashes/MD5/MD5-WeakPass-4Merged.txt
                    # Borrar el archivo comprimido recién descomprimido
              ...
              # Calcular espacio libre disponible antes de instalar la WordList
                if fCalcularEspacioLibre 14; then
                  ...
                  # Descomprimir archivo hacia la ubicación final
                    ...
                    # Renombar el archivo de wordlist a su nombre final
                      mv -vf "$vCarpetaDeWordLists"/EnHashes/MD5/WeakPass-4Policy/weakpass_4.policy.txt.md5.txt "$vCarpetaDeWordLists"/EnHashes/MD5/MD5-WeakPass-4Policy.txt
                    # Borrar el archivo comprimido recién descomprimido
              ...
              # Calcular espacio libre disponible antes de instalar la WordList
                if fCalcularEspacioLibre 335; then
                  ...
                  # Descomprimir archivo hacia la ubicación final
                    ...
                    # Renombar el archivo de wordlist a su nombre final
                      mv -vf "$vCarpetaDeWordLists"/EnHashes/MD5/WeakPass-4aLatin/weakpass_4a.latin.txt.md5.txt "$vCarpetaDeWordLists"/EnHashes/MD5/MD5-WeakPass-4aLatin.txt
                    # Borrar el archivo comprimido recién descomprimido
              ...
              # Calcular espacio libre disponible antes de instalar la WordList
                if fCalcularEspacioLibre 73; then
                  ...
                  # Descomprimir archivo hacia la ubicación final
                    ...
                    # Renombar el archivo de wordlist a su nombre final
                      mv -vf "$vCarpetaDeWordLists"/EnHashes/MD5/WeakPass-4aPolicy/weakpass_4a.policy.txt.md5.txt "$vCarpetaDeWordLists"/EnHashes/MD5/MD5-WeakPass-4aPolicy.txt
                    # Borrar el archivo comprimido recién descomprimido
              ...
              # Calcular espacio libre disponible antes de instalar la WordList
                if fCalcularEspacioLibre 153; then
                  ...
                  # Descomprimir archivo hacia la ubicación final
                    ...
                    # Renombar el archivo de wordlist a su nombre final
                      mv -vf "$vCarpetaDeWordLists"/EnHashes/MD5/WeakPass-AiOPolicy/all_in_one.policy.txt.md5.txt "$vCarpetaDeWordLists"/EnHashes/MD5/MD5-WeakPass-AiOPolicy.txt
                    # Borrar el archivo comprimido recién descomprimido
              ...
              # Calcular espacio libre disponible antes de instalar la WordList
                if fCalcularEspacioLibre 563; then
                  ...
                  # Descomprimir archivo hacia la ubicación final
                    ...
                    # Renombar el archivo de wordlist a su nombre final
                      mv -vf "$vCarpetaDeWordLists"/EnHashes/MD5/WeakPass-AiOLatin/all_in_one.latin.txt.md5.txt "$vCarpetaDeWordLists"/EnHashes/MD5/MD5-WeakPass-AiOLatin.txt
                    # Borrar el archivo comprimido recién descomprimido
